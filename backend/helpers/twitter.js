...
const TWITTER_CONSUMER_API_KEY = process.env.TWITTER_API_KEY
const TWITTER_CONSUMER_API_SECRET_KEY = process.env.TWITTER_API_SECRET_KEY

const oauthConsumer = new oauth.OAuth(
  'https://twitter.com/oauth/request_token', 'https://twitter.com/oauth/access_token',
  TWITTER_CONSUMER_API_KEY,
  TWITTER_CONSUMER_API_SECRET_KEY,
  '1.0A', 'http://localhost:3001/auth/twitter/callback', 'HMAC-SHA1')
